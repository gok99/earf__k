...
// let realOutput = runFft("");

// let x =[];
// for(let i=0;i<FFT_SIZE;i++) x.push(i); //create a simple dumb x axis for the fft plot
...
// plot(x, realInput, 'input');
// plot(xf, realOutput, 'output');
